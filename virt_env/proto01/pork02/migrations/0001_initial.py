...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='products',
            name='supplier',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pork02.Suppliers'),
        ),
        migrations.AddField(
            model_name='order',
            name='prod_code_sumitomo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pork02.Products'),
        ),
        migrations.AddField(
            model_name='order',
            name='supplier',
